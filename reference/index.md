...
- [`hvtiPlotR-package`](https://ehrlinger.github.io/hvtiPlotR/reference/hvtiPlotR-package.md)
  ...
  hvtiPlotR package for plotting standard graphics for manuscripts and
  presentations using `R` and the `ggplot2` package.
...
- [`hvti_theme_ppt()`](https://ehrlinger.github.io/hvtiPlotR/reference/hvti_theme_ppt.md)
