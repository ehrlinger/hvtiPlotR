...
| Function names   | `hv_<concept>()` constructor + `plot.hv_<concept>()` method (e.g. [`hv_nonparametric()`](https://ehrlinger.github.io/hvtiPlotR/reference/hv_nonparametric.md), [`plot.hv_nonparametric()`](https://ehrlinger.github.io/hvtiPlotR/reference/plot.hv_nonparametric.md))                                                                                                                                                                                                                                                                         |
