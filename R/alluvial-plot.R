...
#'
#' @return An object of class \code{c("hv_alluvial", "hv_data")}:
#' \describe{
...
#'
#' @param x   An \code{hv_alluvial} object from \code{\link{hv_alluvial}}.
#' @param ... Ignored.
#' @return \code{x}, invisibly.
#' @export
print.hv_alluvial <- function(x, ...) {
  m <- x$meta
  cat("<hv_alluvial>\n")
