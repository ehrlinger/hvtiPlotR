...
#'
#' A large-font theme with a black panel background and white text, suited to
#' dark-mode PowerPoint slides. Removes grid lines and panel borders.
#'
...
#'
#' @seealso [hvti_theme()], [theme_man()], [theme_ppt()], [theme_poster()]
#'
#' @import ggplot2
#' @export
