...
#   2. survival_curve -> hvti_theme -> save_ppt (full pipeline)
...
# ============================================================================
# End-to-end: survival_curve → hvti_theme → save_ppt
# ============================================================================

test_that("full pipeline: survival_curve + hvti_theme + save_ppt (single plot)", {
  skip_if_not_installed("officer")
...
test_that("full pipeline: list of plots → save_ppt (multi-slide)", {
  ...
  km <- survival_curve(sample_survival_data(n = 100, seed = 1))
  p2 <- eda_plot(sample_eda_data(n = 100, seed = 1), y_col = "ef",
                 x_col = "op_years")
  ...
  expect_no_error(
    save_ppt(
      object       = list(km + hvti_theme("ppt"), p2 + hvti_theme("ppt")),
      template     = template,
      powerpoint   = pptx_out,
...
# ============================================================================
# End-to-end: nonparametric curve plot + data points + theme
# ============================================================================

test_that("nonparametric_curve_plot with CI + data points + theme composes cleanly", {
