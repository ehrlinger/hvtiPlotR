...
%\VignetteIndexEntry{ccfPlotting}
...
\Plaintitle{ccfPlotting: Generating plot.sas style figures in R} %% without formatting
\Shorttitle{{\pkg{ccfPlotting}}: Generating \code{plot.sas} style figures}

%% an abstract and keywords
\Abstract{ 
We introduce the \proglang{R} package \pkg{ccfPlotting}.}
...
% =======================================
In this article, we present some functions in the \pkg{ccfPlotting} package for \proglang{R} 
