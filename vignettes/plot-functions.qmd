...
|---|---|---|
| `hvti_mirror()` | — | `tp.lp.mirror-histogram_SAVR-TF-TAVR.R`, `tp.lp.mirror_histo_before_after_wt.R` |
| `hvti_stacked()` | — | — |
...
A common figure in propensity-matched analyses is the mirrored histogram, which displays the propensity score distributions for two treatment groups before and after matching. The **hvtiPlotR** package provides the `hvti_mirror()` constructor to prepare the data, and `plot()` to render the figure.
