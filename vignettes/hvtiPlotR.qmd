...
n <- 300
gfup_dta <- data.frame(
  iv_opyrs = runif(n, 0, 29),          # years from 1990 to operation
  iv_dead  = runif(n, 0, 25),          # follow-up years to death or censoring
  dead     = sample(c(TRUE, FALSE), n, replace = TRUE, prob = c(0.3, 0.7))
)
head(gfup_dta)
```
