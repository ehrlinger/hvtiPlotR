...
weights so the figure reads at distance. You can see the full difference by swapping the theme call at the end
of a pipeline -- everything else stays the same.
