...
is for journal figures (black on white, smaller text, no title), while the
poster and slide themes scale up text and line weights so the figure reads at
distance. You can see the full difference by swapping the theme call at the end
