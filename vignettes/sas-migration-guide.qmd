...
| `tp.lp.mirror-histogram_SAVR-TF-TAVR.R` | lp | `hvti_mirror()` | [Mirror histogram — binary-match](#dp-mirror) |
...
Both scripts are superseded by `hvti_mirror()`. Call `plot(mh)` to render the
