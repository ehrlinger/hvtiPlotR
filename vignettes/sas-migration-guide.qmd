...
measurement), so the bar heights are the same counts `PROC FREQ` gave you —
only the rendering moves to R. The output is a bar chart; any goodness-of-follow-up threshold
