...
`PLOTH`, `PLOTL`). Because the estimates come from `survfit()`, the survival
curve, confidence limits, and numbers at risk match what `%kaplan` reports —
you are swapping the plotting step, not the estimator. Tidy data frames live
in `km$tables`.
